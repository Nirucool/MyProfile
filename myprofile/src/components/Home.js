...
class Home extends Component {
            ...
            <div className="main-container">
                ...
                <form className="container" style={{marginTop: '50px'}}>
                    ...
                    <FormGroup row style={{fontSize:'14px',marginTop: '50px',  color: 'lightyellow'}}>
                              ...
                              <svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" width="1344" height="2500"
                                   ...
                                   <svg style={{marginLeft: '5px'}} width="2500" height="2246" viewBox="0 0 256 230"
                                  ...
                                  <svg style={{marginLeft: '5px'}} width="2500" height="713" viewBox="0 0 512 146"
                                    ...
                                    <svg style={{marginLeft: '5px'}} width="2065" height="2500" viewBox="0 0 256 310"
                                ...
                                <svg style={{marginLeft: '5px'}} width="2500" height="2490" viewBox="0 0 256 255"
                                                   xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <defs>
                                   ...
                                   <svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                        <g fill="#764ABC">
                                            <path
                                   ...
                                   <svg style={{marginLeft: '5px'}} width="1600" height="2500" viewBox="0 0 256 400"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <path
                              ...
                              <svg style={{marginLeft: '5px'}} viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
                                   ...
                                   <svg style={{marginLeft: '5px'}} width="2424" height="2500" viewBox="0 0 256 264"
                                                       xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <path
                                  ...
                                  <svg style={{marginLeft: '5px'}} width="2397" height="2500" viewBox="0 0 256 267"
                                              xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                        <path
                               ...
                               <svg style={{marginLeft: '5px'}} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	...
	L13.25,76.19C5.962,80.397,0,90.725,0,99.14v146.069c0,4.208,1.491,8.894,3.893,13.053L153,172.175L302.108,86.087z"/>
		...
		263.5,177.841 274.834,177.841 274.834,189.175 286.166,189.175 286.166,177.841 297.5,177.841 	"/>
                                ...
                                <svg style={{marginLeft: '5px'}} width="2270" height="2500" viewBox="0 0 256 282"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <g fill="#8CC84B">
                                            <path
                                ...
                                <svg style={{marginLeft: '5px'}} width="2500" height="2500" viewBox="0 0 256 256"
                                                      xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                        <defs>
                               ...
                               <svg style={{marginLeft: '5px'}} height="32px" version="1.1" viewBox="0 0 32 32" width="32px" xmlns="http://www.w3.org/2000/svg"><title/><desc/><defs/><g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1"><g fill="#157EFB" id="icon-89-document-file-sql"><path d="M21,26 L21,28.0025781 C21,29.1090746 20.1057238,30 19.0025781,30 L3.99742191,30 C2.89092539,30 2,29.1012878 2,27.9926701 L2,5.00732994 C2,3.89833832 2.8992496,3 4.0085302,3 L14,3 L14,9.00189865 C14,10.1132936 14.8980806,11 16.0059191,11 L21,11 L21,13 L11.0068483,13 C9.34621185,13 8,14.3422643 8,15.9987856 L8,23.0012144 C8,24.6573979 9.33599155,26 11.0068483,26 L21,26 L21,26 Z M15,3 L15,8.99707067 C15,9.55097324 15.4509752,10 15.990778,10 L21,10 L15,3 L15,3 Z M10.9945615,14 C9.89299558,14 9,14.9001762 9,15.992017 L9,23.007983 C9,24.1081436 9.90234375,25 10.9945615,25 L28.0054385,25 C29.1070044,25 30,24.0998238 30,23.007983 L30,15.992017 C30,14.8918564 29.0976562,14 28.0054385,14 L10.9945615,14 L10.9945615,14 Z M20.6756443,22.8827511 C20.463169,22.9587282 20.2340236,23 19.9951185,23 L19.0048815,23 C17.8938998,23 17,22.1019194 17,20.9940809 L17,18.0059191 C17,16.8865548 17.897616,16 19.0048815,16 L19.9951185,16 C21.1061002,16 22,16.8980806 22,18.0059191 L22,20.9940809 C22,21.4993595 21.8171018,21.9572008 21.5145823,22.3074755 L22.267767,23.0606602 L21.5606602,23.767767 L20.6756443,22.8827511 L20.6756443,22.8827511 L20.6756443,22.8827511 Z M19.7928932,22 L18.9989566,22 C18.4426603,22 18,21.5523709 18,21.0001925 L18,17.9998075 C18,17.4437166 18.4472481,17 18.9989566,17 L20.0010434,17 C20.5573397,17 21,17.4476291 21,17.9998075 L21,21.0001925 C21,21.2246463 20.9271364,21.4307925 20.8039499,21.5968431 L19.4393398,20.232233 L18.732233,20.9393398 L19.7928932,22 L19.7928932,22 L19.7928932,22 Z M13.0048815,16 C11.897616,16 11,16.8877296 11,18 C11,19.1045695 11.8877296,20 13,20 L13.9906311,20 C14.5480902,20 15,20.4438648 15,21 C15,21.5522847 14.5573397,22 14.0010434,22 L12.9989566,22 C12.4472481,22 12,21.543716 12,21.0044713 L12,20.9931641 L11,20.9931641 L11,20.998921 C11,22.1040864 11.8938998,23 13.0048815,23 L13.9951185,23 C15.102384,23 16,22.1122704 16,21 C16,19.8954305 15.1122704,19 14,19 L13.0093689,19 C12.4519098,19 12,18.5561352 12,18 C12,17.4477153 12.4426603,17 12.9989566,17 L14.0010434,17 C14.5527519,17 15,17.453186 15,18 L16,18 C16,16.8954305 15.1061002,16 13.9951185,16 L13.0048815,16 L13.0048815,16 Z M28,22 L28,23 L23,23 L23,16 L24,16 L24,22 L28,22 L28,22 Z" id="document-file-sql"/></g></g></svg>
                                   <svg style={{marginLeft: '5px', backgroundColor: 'white'}} width="2500" height="2480"
                                   ...
                                   <svg style={{marginLeft: '5px'}} width="2500" height="2158" viewBox="0 0 256 221"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                             ...
                             <svg style={{marginLeft: '5px', backgroundColor: 'white'}} width="1773" height="2500"
                                ...
                                <svg style={{marginLeft: '5px', backgroundColor: 'white'}} xmlns="http://www.w3.org/2000/svg"
