                   ...
                   {/* <FormGroup row style={{fontStyle: 'oblique', color: 'dodgerblue', fontFamily: 'monospace'}}>
                    ...
                    <FormGroup row style={{fontSize: '15px', color: 'grey', textAlign: 'justify'}}>
                        ...
                        <Col sm={8}>
                            ...
                            TIAA, Mumbai employees to share rides with office colleagues using Spring Boot and MongoDB to avoid Mumbai traffic and to save commute time. I am working on a personal project to help small landscaping businesses thrive by creating a web application where they can showcase their work and end users can book them if they like their work and price quotes. I also like working on projects related to Natural Language Processing and Machine Learning.
                        </Col>
                    </FormGroup>
                    <FormGroup row style={{marginTop: '50px', fontSize: '20px', color: 'mediumseagreen'}}>
                        <Col sm={4}>
                    ...
                    <FormGroup row style={{fontSize: '15px', color: 'grey', textAlign: 'justify'}}>
                        ...
                        <Col sm={8}>
                            I like learning new languages and frameworks. I love designing applications as much as I love programming.
                            I am curious about the development of
                            AI
                            enabled websites and I look forward to work on customer facing AI applications. I like taking new challenges and always
                    ...
                    <FormGroup row style={{fontSize: '15px', color: 'grey', textAlign: 'justify'}}>
                        ...
                        <svg style={{marginLeft: '20px'}} width="2270" height="2500" viewBox="0 0 256 282"
                        ...
                        <svg style={{marginLeft: '20px'}} xmlns="http://www.w3.org/2000/svg" width="1344" height="2500"
                        ...
                        <svg style={{marginLeft: '20px'}} width="2500" height="713" viewBox="0 0 512 146"
                        ...
                        <svg style={{marginLeft: '20px'}} width="2500" height="2246" viewBox="0 0 256 230"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                            <path
                        ...
                        <svg style={{marginLeft: '20px'}} width="2500" height="2490" viewBox="0 0 256 255"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                            <defs>
                        ...
                        <svg style={{marginLeft: '20px'}} xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                        ...
                        <svg style={{marginLeft: '20px'}} width="2424" height="2500" viewBox="0 0 256 264"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                            <path
                        ...
                        <svg style={{marginLeft: '20px'}} width="2065" height="2500" viewBox="0 0 256 310"
                        ...
                        <svg style={{marginLeft: '20px', backgroundColor: 'white'}} width="1773" height="2500"
                        ...
                        <svg style={{marginLeft: '20px'}} width="1600" height="2500" viewBox="0 0 256 400"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                            <path
                        ...
                        <svg style={{marginLeft: '20px', backgroundColor: 'white'}} width="2490" height="2500"
                        ...
                        <svg style={{marginLeft: '20px'}} width="2500" height="2158" viewBox="0 0 256 221"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                        ...
                        <svg style={{marginLeft: '20px'}} width="2500" height="2500" viewBox="0 0 256 256"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                            <defs>
                        ...
                        <svg style={{marginLeft: '20px', backgroundColor: 'white'}} xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg style={{marginLeft: '20px', backgroundColor: 'white'}} width="2500" height="2480"
                        ...
                        <svg style={{marginLeft: '20px'}} width="2397" height="2500" viewBox="0 0 256 267"
                             xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                            <path
