...
class Home extends Component {
                    ...
                    <FormGroup row>
                        <Col sm={7}>
                            <Zoom left>
                                <h2><span style={{
                                    color: 'lightyellow',
                                    fontFamily: '"Chronicle Display Bold",Georgia,serif',
                                    fontSize: '40px'
                                }}>Hey, I'm Nirupama</span></h2>
                                <h2><span
                                    style={{
                                        color: 'black',
                            ...
                            <p style={{
                                ...
                                width: '805px',
                                paddingRight: '10px'
                            }}>I am a Full Stack Software Engineer with 4 years of work experience with Fortune 500 companies like TIAA, New York Life etc.
                    ...
                    <FormGroup row style={{fontSize:'14px',marginTop: '50px',  color: 'lightyellow'}}>
                        ...
                        <Table class="no-border">
                            ...
                            <tr style={{color:'dodgerblue'}}>
                                ...
                                <tbody>
                                <tr>
                                    <td>Java<svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" width="1344" height="2500"
                                    ...
                                    <td>React <svg style={{marginLeft: '5px'}} width="2500" height="2246" viewBox="0 0 256 230"
                                    ...
                                    <td>MongoDB <svg style={{marginLeft: '5px'}} width="2500" height="713" viewBox="0 0 512 146"
                                    ...
                                    <td>AWS EC2 <svg style={{marginLeft: '5px'}} width="2065" height="2500" viewBox="0 0 256 310"
                                ...
                                <tr>
                                    <td>Python<svg style={{marginLeft: '5px'}} width="2500" height="2490" viewBox="0 0 256 255"
                                                   xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <defs>
                                    ...
                                    <td>Redux<svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                        <g fill="#764ABC">
                                            <path
                                    ...
                                    <td>MySQL
                                        <svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                                    ...
                                    <td>Heroku<svg style={{marginLeft: '5px'}} width="1600" height="2500" viewBox="0 0 256 400"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <path
                                ...
                                <tr>
                                    <td>Ruby<svg style={{marginLeft: '5px'}} viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
                                    ...
                                    <td>Ruby on Rails<svg style={{marginLeft: '5px'}} viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
                                    ...
                                    <td>PostgreSQL<svg style={{marginLeft: '5px'}} width="2424" height="2500" viewBox="0 0 256 264"
                                                       xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <path
                                    ...
                                    <td> Hibernate<svg style={{marginLeft: '5px'}} width="2397" height="2500" viewBox="0 0 256 267"
                                              xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                        <path
                                ...
                                <tr>
                                    <td>C++ <svg style={{marginLeft: '5px'}} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	...
	L13.25,76.19C5.962,80.397,0,90.725,0,99.14v146.069c0,4.208,1.491,8.894,3.893,13.053L153,172.175L302.108,86.087z"/>
		...
		263.5,177.841 274.834,177.841 274.834,189.175 286.166,189.175 286.166,177.841 297.5,177.841 	"/>
                                    ...
                                    <td>Node JS <svg style={{marginLeft: '5px'}} width="2270" height="2500" viewBox="0 0 256 282"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                        <g fill="#8CC84B">
                                            <path
                                    ...
                                    <td></td>
                                    <td>IntelliJ <svg style={{marginLeft: '5px'}} width="2500" height="2500" viewBox="0 0 256 256"
                                                      xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                        <defs>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Gradle
                                        <svg style={{marginLeft: '5px', backgroundColor: 'white'}} width="2490" height="2500"
                                ...
                                <tr>
                                    <td></td>
                                    <td>Vue.js<svg style={{marginLeft: '5px'}} width="2500" height="2158" viewBox="0 0 256 221"
                                                     xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                                    ...
                                    <td></td>
                                    <td>Linux <svg style={{marginLeft: '5px'}} xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                                                   viewBox="0 0 192.756 192.756">
                                        <g fill-rule="evenodd" clip-rule="evenodd">
                                            <path fill="#fff" d="M0 0h192.756v192.756H0V0z"/>
                                            <path
                               ...
                               {/* <tr>
                                    <td></td>
                                    <td>HTML5<svg style={{marginLeft: '5px', backgroundColor: 'white'}} width="1773" height="2500"
                                ...
                                <tr>
                                    <td></td>
                                    <td>CSS3 <svg style={{marginLeft: '5px', backgroundColor: 'white'}} xmlns="http://www.w3.org/2000/svg"
                                ...
                                <tr>
                                    <td></td>
                                    <td>JSON <svg style={{marginLeft: '5px', backgroundColor: 'white'}} xmlns="http://www.w3.org/2000/svg"
